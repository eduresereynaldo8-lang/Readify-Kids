...
<div style="background:#fff;
    ...
    <form method="GET"
          action="{{ route('student.game.index') }}"
        ...
        <div style="position:relative;
            ...
            <input type="text"
                   ...
                   placeholder="Search battle activities..."
        ...
        <select name="level"
            ...
            <option value="1"
                {{ request('level') == '1' ? 'selected' : '' }}>
                Level 1 — Goblin
            </option>

            <option value="2"
                {{ request('level') == '2' ? 'selected' : '' }}>
                Level 2 — Witch
            </option>

            <option value="3"
                {{ request('level') == '3' ? 'selected' : '' }}>
                Level 3 — Dragon
            </option>
    ...
    <div class="col-md-6 col-lg-4">
        ...
        <div class="dash-card h-100"
             ...
             onmouseover="this.style.borderColor='#7C3AED';
                          this.style.boxShadow='0 4px 20px rgba(124,58,237,0.15)'"
            ...
            <div style="background:linear-gradient(135deg,#1E1B4B,#312E81);
                ...
                <div style="font-size:56px;margin-bottom:6px;">
                    {{ $enemy?->sprite ?? '👾' }}
                </div>
            ...
            <div style="background:#F5F3FF;
                ...
                📖
                <strong>
                    {{ $activity->wordBank->count() }}
                </strong>
                words/paragraphs to read ·

                <strong>

                    @if($activity->level == 1)
                        Single words
                    @elseif($activity->level == 2)
                        Short phrases
                    @else
                        Paragraphs
                    @endif
            ...
            @php
                ...
                |--------------------------------------------------------------------------
                | FIX:
                | Use $sessions because the controller returns $sessions.
                |--------------------------------------------------------------------------
                */

                $sess = $sessions->get($activity->id);
            ...
            @elseif($sessStatus === 'ongoing')
                ...
                <div style="text-align:center;
                    ...
                    {{ $sess->rounds_played }} rounds played

                </div>


                {{-- FIX:
                     Continue using the existing session ID --}}
        ...
        <div class="dash-card text-center py-5">
            ...
            <div class="text-muted small">
                ...
                @else
                    ...
                    Ask your teacher to add some activities!
...
{{-- =========================================================
     MOBILE RESPONSIVE ONLY FOR SEARCH/FILTER
     Does NOT change your existing card design
     ========================================================= --}}
<style>
...
@media (max-width: 768px) {
    ...
    .battle-filter-form > div:first-child {
        width:100%;
        flex:100% !important;
        min-width:100% !important;
    }

    .battle-filter-form select {
        flex:1;
        min-width:0;
...
@media (max-width: 480px) {
    ...
    .battle-filter-form select,
    .battle-filter-form button,
    .battle-filter-form a {
        width:100% !important;
        min-height:38px;
    }
