...
<div class="dash-card mb-3 d-flex align-items-center gap-3">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('teacher.students.exportPdf', $student->id) }}" class="btn btn-sm btn-outline-primary">
    ...
    <div class="col-md-4">
        <div class="dash-card">
            ...
            <div class="d-flex justify-content-between py-1" style="font-size:12px;">
                ...
                <strong>{{ $student->activities_completed }}</strong>
            </div>
        </div>
    </div>
...
<table class="dash-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:#9CA3AF;">{{ $result->completed_at ? \Carbon\Carbon::parse($result->completed_at)->format('M d, Y') : '—' }}</td>
                    </tr>
                    @empty
